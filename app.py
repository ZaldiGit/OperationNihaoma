    ...
    with tabs[1]:
        if students_df.empty:
            ...
            with st.form("form_create_invoice_package"):
                ...
                tanggal_kirim = st.text_input("Tanggal Kirim", value="", key="package_tanggal_kirim")
    ...
    with tabs[2]:
        if students_df.empty:
            ...
            with st.form("form_create_invoice"):
                c1, c2, c3 = st.columns(3)
                tanggal_invoice = c1.text_input("Tanggal Invoice", value=str(datetime.now().date()), key="manual_tanggal_invoice")
                ...
                program = st.text_input("Program", value=safe_text(student.get("program_diminati")), key="manual_program")
                ...
                tanggal_kirim = st.text_input("Tanggal Kirim", value="", key="manual_tanggal_kirim")
